  ...
  return (
    <div className="p-2 group cursor-pointer transition duration-200 ease-in transform sm:hover:scale-105 hover:z-50">
        <Image src={
            ...
            } layout="responsive" height={1080} width={1920} alt="" />
  <div className="p-2">
      <p className="truncate max-w-md max-h-6">{result.overview}</p> 
        <p className="opacity-0 group-hover:opacity-100">{result.overview}</p> 
